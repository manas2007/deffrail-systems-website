...
export const SERVICES_DATA = {
    "water-management": {
        ...
        hero: {
            ...
            supportingText:
                "Advanced FRP water storage systems engineered for durability, corrosion resistance, and long term performance across residential, commercial, industrial, and government applications.",
            image: "/assets/propertyDetail/waterManagement/Water-Management-Hero-Img.png",
        },

        intro: {
            heading: "Reliable Water Storage Built for Modern Infrastructure",
            content: [
                "Deffrail Systems develops high performance FRP water storage solutions designed to meet the growing demands of modern infrastructure and water conservation. Manufactured using advanced CNC Filament Winding technology, these tanks are engineered for superior strength, lightweight handling, and long operational life.",

                "The systems are suitable for water storage, rainwater harvesting, firefighting reserves, and industrial applications where durability and reliability are critical. Designed for both underground and above ground installations, Deffrail Systems FRP tanks offer leak resistant construction, corrosion resistance, and minimal maintenance requirements.",

                "Widely used across residential projects, commercial facilities, industries, institutions, and government sectors, these solutions support sustainable water management with efficient installation and dependable performance.",
            ],
            image: "/images/services/water-management/intro.jpg",
        },

        advantage: {
            heading: "The FRP Water Storage Advantage",
            description:
                "Deffrail Systems FRP tanks are designed to deliver long term operational efficiency while reducing installation complexity and lifecycle maintenance challenges.",

            bulletPoints: [
                "Corrosion resistant FRP construction for long service life",
                "Lightweight structure for easier transportation and installation",
                "Suitable for underground and above ground applications",
                "Ideal for water storage, rainwater harvesting, and fire reserve systems",
            ],
        },
        productListing: [
            {
    ...
    "sewage-management": {
        ...
        hero: {
            heading: "Sewage Management",
            supportingText:
                "Advanced FRP packaged sewage treatment and septic solutions designed for efficient wastewater treatment, water reuse, and sustainable sanitation infrastructure.",
            image: "/assets/propertyDetail/sewageManagement/Sewage-Management-Hero-Img.png",
        },

        intro: {
            heading: "Wastewater Solutions for Sustainable Infrastructure",
            content: [
                "Deffrail Systems offers advanced FRP based sewage management solutions developed for residential, commercial, institutional, industrial, and municipal applications. The systems are designed to treat wastewater efficiently while supporting water reuse and environmentally responsible operations.",

                "The FRP Packaged Sewage Treatment Plant (PSTP) uses MBBR based biological treatment technology to reduce BOD, COD, suspended solids, and wastewater contaminants effectively. Built with high strength FRP construction, these systems provide corrosion resistance, zero leakage performance, and long operational durability.",

                "Integrated tertiary treatment options further enhance treated water quality, making it suitable for reuse in flushing, gardening, cooling systems, and non potable applications. With modular underground installation and smart monitoring compatibility, Deffrail Systems delivers efficient and scalable wastewater infrastructure solutions.",
            ],
            image: "/images/services/sewage-management/intro.jpg",
        },

        advantage: {
            heading: "Smart Wastewater Treatment Performance",
            description:
                "Built for long term efficiency and environmental responsibility, Deffrail Systems sewage management systems combine advanced treatment technology with durable FRP engineering.",

            bulletPoints: [
                "MBBR based treatment for efficient BOD and COD reduction",
                "Leak proof and corrosion resistant FRP structure",
                "Reusable treated water for sustainable water management",
                "Suitable for residential, industrial, institutional, and municipal projects",
            ],
        },
        productListing: [
            {
    ...
    "lightweight-frp-solutions": {
        id: "lightweight-frp-solutions",

        hero: {
            heading: "Lightweight FRP Solutions",
            supportingText:
                "High strength lightweight composite solutions engineered to improve handling, durability, and operational efficiency across industrial and infrastructure applications.",
            image: "/assets/propertyDetail/lightweightSolutions/Header-Img.png",
        },

        intro: {
            heading: "Lightweight Performance Without Compromising Strength",
            content: [
                "Deffrail Systems develops FRP based lightweight solutions designed to improve operational efficiency while maintaining structural reliability and long term durability. Manufactured using advanced composite technologies, these systems offer a superior strength to weight ratio compared to conventional construction materials.",
                "The lightweight nature of FRP solutions enables easier transportation, faster installation, and reduced structural load requirements across infrastructure and industrial projects. Their corrosion resistant and low maintenance properties make them suitable for demanding environments where long service life and performance consistency are essential.",
                "Widely applied across water management, sanitation, industrial storage, and infrastructure applications, Deffrail Systems lightweight solutions support smarter and more sustainable engineering practices.",
            ],
            image: "/images/services/lightweight-frp-solutions/intro.jpg",
        },

        advantage: {
            heading: "The Composite Performance Advantage",
            description:
                "FRP lightweight systems are engineered to deliver high structural performance while simplifying transportation, installation, and long term maintenance.",
            bulletPoints: [
                "High strength to weight ratio for improved efficiency",
                "Easier transportation and faster installation processes",
                "Corrosion resistant construction with low maintenance needs",
                "Suitable for industrial, infrastructure, and utility applications",
            ],
        },
        productListing: [
            {
    ...
    "warehousing-storage-solutions": {
        id: "warehousing-storage-solutions",
        hero: {
            heading: "Warehousing & Storage Solutions",
            supportingText:
                "Durable FRP and rotational moulded storage systems designed for safe material handling, industrial storage, and efficient operational management.",
            image: "/assets/propertyDetail/warehousing/Warehousing-Hero-Image.png",
        },
        intro: {
            heading: "Reliable Storage Systems for Industrial Operations",
            content: [
                "Deffrail Systems offers a wide range of industrial storage and warehousing solutions engineered for durability, chemical resistance, and efficient material handling. Manufactured using high quality rotational moulding and FRP technologies, these products are designed to perform reliably across demanding industrial environments.",

                "The product range includes processing trolleys, pallet containers, cylindrical vessels, trough containers, spillage pallets, mixing tanks, and industrial handling systems. Designed with seamless construction and smooth interior surfaces, these solutions support easy cleaning, maintenance free performance, and long operational life.",

                "Built using durable and lightweight materials, Deffrail Systems storage solutions are suitable for manufacturing facilities, chemical industries, warehousing operations, and industrial processing applications where reliability and efficiency are essential.",
            ],
            image: "/images/services/warehousing-storage-solutions/intro.jpg",
        },

        advantage: {
            heading: "Designed for Industrial Efficiency",
            description:
                "Deffrail Systems storage and warehousing products are developed to improve operational handling, storage safety, and industrial durability.",

            bulletPoints: [
                "Chemical resistant and maintenance free construction",
                "Lightweight yet durable storage systems for industrial use",
                "Seamless design with smooth surfaces for easy cleaning",
                "Suitable for warehousing, processing, and material handling applications",
            ],
        },
        productListing: [
            {
    ...
    "sanitary-management": {
        id: "sanitary-management",

        hero: {
            heading: "Sanitary Management",
            supportingText:
                "Portable sanitation and waste management systems designed for hygiene, durability, and efficient deployment across commercial, industrial, and public infrastructure projects.",
            image: "/assets/propertyDetail/sanitaryManagement/Sanitary-Management-Hero-Img.png",
        },

        intro: {
            heading: "Practical Sanitation Infrastructure for Modern Environments",
            content: [
                "Deffrail Systems provides advanced sanitary management solutions developed to support hygienic, durable, and easy to maintain sanitation infrastructure. The product range includes mobile toilets, sanitary cabins, dustbins, changing rooms, and multi utility sanitation systems designed for diverse operational environments.",

                "Manufactured using rotational moulding technologies and high quality materials, these solutions are lightweight, corrosion resistant, easy to relocate, and built for long term outdoor use. Their low maintenance construction and ready to use design make them suitable for government projects, construction sites, institutions, industrial facilities, events, and public sanitation requirements.",

                "With a focus on operational convenience and hygiene standards, Deffrail Systems sanitary solutions support modern infrastructure needs through practical and durable engineering.",
            ],
            image: "/images/services/sanitary-management/intro.jpg",
        },

        advantage: {
            heading: "Built for Hygiene, Durability, and Mobility",
            description:
                "Deffrail Systems sanitary products are engineered for dependable performance across temporary and permanent sanitation applications.",
            bulletPoints: [
                "Lightweight and easy to relocate infrastructure systems",
                "Corrosion resistant and maintenance friendly construction",
                "Suitable for public, industrial, institutional, and commercial use",
                "Designed for long term outdoor durability and hygiene management",
            ],
        },
        productListing: [
            {
    ...
    "high-altitude-shelters": {
        id: "high-altitude-shelters",

        hero: {
            heading: "High Altitude Shelters",
            supportingText:
                "Durable lightweight composite infrastructure solutions engineered for demanding environmental conditions and remote deployment applications.",
            image: "/assets/propertyDetail/highAltitudeShelters/High-Altitude-Shelters-Hero-Img.png",
        },
        ...
        advantage: {
            heading: "Performance Built for Extreme Conditions",
            description:
                "Designed for operational reliability in remote and high demand environments, these lightweight composite systems support efficient deployment and long term durability.",

            bulletPoints: [
                "Lightweight construction for easier transportation and deployment",
                "Durable FRP structure for harsh environmental conditions",
                "Low maintenance and corrosion resistant performance",
                "Suitable for remote infrastructure and institutional applications",
            ],
        },
        productListing: [
            {
